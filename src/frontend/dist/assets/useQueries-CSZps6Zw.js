...
import { S as Subscribable, p as pendingThenable, b as resolveEnabled, d as shallowEqualObjects, e as resolveStaleTime, n as noop, f as environmentManager, i as isValidTimeout, t as timeUntilStale, h as timeoutManager, k as focusManager, l as fetchState, m as replaceData, q as notifyManager, w as hashKey, x as getDefaultState, r as reactExports, y as shouldThrowError, z as useQueryClient } from "./index-DcI09W8W.js";
...
const Result_9 = Variant({ "ok": FoodItem, "err": Text });
const PlaySlot = Record({
  "id": Text,
  "startTime": Text,
  "endTime": Text,
  "ownerId": Text,
...
const Result_8 = Variant({ "ok": PlaySlot, "err": Text });
const RetailItem = Record({
  "id": Text,
  "inStock": Bool,
  "ownerId": Text,
...
const Result_7 = Variant({ "ok": RetailItem, "err": Text });
const StayRoom = Record({
  "id": Text,
  "ownerId": Text,
  "pricePerNight": Nat,
  "isAvailable": Bool,
...
const Result_6 = Variant({ "ok": StayRoom, "err": Text });
const UserId = Text;
const Timestamp = Int;
...
const Result_5 = Variant({ "ok": OwnerRecord, "err": Text });
...
const Result_4 = Variant({ "ok": Booking, "err": Text });
const SoundType = Variant({
  "alarm": Null,
  "ping": Null,
  "silent": Null
});
...
const Result_3 = Variant({ "ok": Notification, "err": Text });
const TicketStatus = Variant({
  "resolved": Null,
  "open": Null
});
const TicketMessage = Record({
  "text": Text,
  "sender": Text,
  "timestamp": Timestamp
});
...
const Result_2 = Variant({ "ok": Ticket, "err": Text });
...
const OwnerRevenue = Record({
  "ownerId": Text,
  "businessName": Text,
  "todayRevenue": Nat,
  "totalRevenue": Nat
});
const Result_1 = Variant({ "ok": UserRecord, "err": Text });
Service({
  "addBookedDate": Func([Text, Text], [Result], []),
  "addCategory": Func(
    [Text, Text, Category, Vec(Text)],
    [Result_10],
    []
  ),
  "addFoodItem": Func(
    [Text, Text, Nat, Bool, Text],
    [Result_9],
    []
  ),
  "addPlaySlot": Func(
    [Text, Text, Text, Text, Text, Nat, Text],
    [Result_8],
    []
  ),
  "addRetailItem": Func(
    [Text, Text, Nat, Text, Nat],
    [Result_7],
    []
  ),
  "addStayRoom": Func(
    [Text, Text, Vec(Text), Nat],
    [Result_6],
    []
  ),
  "addTicketMessage": Func([Text, Text, Text], [Result], []),
  "banUser": Func([Text, Bool], [Result], []),
  "completeOwnerOnboarding": Func(
  ...
  "createNotification": Func(
    [Text, Text, Text, SoundType],
    [Result_3],
    []
  ),
  "createStayBooking": Func([Text, Text, Text], [Result], []),
  "createTicket": Func(
    [Text, Opt(Text), Text, Text, Opt(Text)],
    [Result_2],
    []
  ),
  "deleteCategory": Func([Text], [Result], []),
  "deleteFoodItem": Func([Text], [Result], []),
  "deleteOwner": Func([Text], [Result], []),
  "deleteUser": Func([Text], [Result], []),
  "getActiveCategories": Func([], [Vec(CategoryEntry)], ["query"]),
  "getActiveOwners": Func([], [Vec(OwnerRecord)], ["query"]),
  "getAdminStats": Func([], [AdminStats], ["query"]),
  "getAllBookings": Func([], [Vec(Booking)], ["query"]),
  "getAllCategories": Func([], [Vec(CategoryEntry)], ["query"]),
  "getAllFoodItems": Func([], [Vec(FoodItem)], ["query"]),
  "getAllNotifications": Func([], [Vec(Notification)], ["query"]),
  "getAllOwners": Func([], [Vec(OwnerRecord)], ["query"]),
  "getAllOwnersAdmin": Func([], [Vec(OwnerRecord)], ["query"]),
  "getAllPlaySlots": Func([], [Vec(PlaySlot)], ["query"]),
  "getAllRetailItems": Func([], [Vec(RetailItem)], ["query"]),
  "getAllStayRooms": Func([], [Vec(StayRoom)], ["query"]),
  "getAllTickets": Func([], [Vec(Ticket)], ["query"]),
  "getAllUsers": Func([], [Vec(UserRecord)], ["query"]),
  "getBookingsByOwner": Func([Text], [Vec(Booking)], ["query"]),
  "getBookingsByUser": Func([Text], [Vec(Booking)], ["query"]),
  "getDeliveryFee": Func(
    [Text, Float64, Float64],
    [Nat],
    ["query"]
  ),
  "getFoodItemsByOwner": Func([Text], [Vec(FoodItem)], ["query"]),
  "getNotificationsByTarget": Func(
    [Text],
    [Vec(Notification)],
    ["query"]
  ),
  "getOwnerById": Func([Text], [Opt(OwnerRecord)], ["query"]),
  "getOwnersByCategory": Func(
    [Category],
    [Vec(OwnerRecord)],
    ["query"]
  ),
  "getPlaySlotsByOwner": Func([Text], [Vec(PlaySlot)], ["query"]),
  "getRetailItemsByOwner": Func(
    [Text],
    [Vec(RetailItem)],
    ["query"]
  ),
  "getRevenueByOwner": Func([], [Vec(OwnerRevenue)], ["query"]),
  "getSlotsByDate": Func(
    [Text, Text],
    [Vec(PlaySlot)],
    ["query"]
  ),
  "getStayAvailability": Func(
    [Text, Text, Text],
    [Bool],
    ["query"]
  ),
  "getStayRoomsByOwner": Func([Text], [Vec(StayRoom)], ["query"]),
  "getTicketsByOwner": Func([Text], [Vec(Ticket)], ["query"]),
  "getTicketsByUser": Func([Text], [Vec(Ticket)], ["query"]),
  "getUserById": Func([Text], [Opt(UserRecord)], ["query"]),
  "logActivity": Func([Text, Text], [], []),
  "markNotificationRead": Func([Text], [Result], []),
  "resolveTicket": Func([Text], [Result], []),
  "signinUser": Func([Text, Text], [Result_1], []),
  "signupUser": Func(
    [
      Text,
      Text,
  ...
  "toggleSlotBooking": Func(
    [Text, Bool, Opt(Text)],
    [Result],
    []
  ),
  "updateBookingStatus": Func([Text, BookingStatus], [Result], []),
  "updateCategory": Func(
    [Text, Text, Text, Bool, Vec(Text)],
    [Result],
    []
  ),
  "updateDeliveryFeePerKm": Func([Text, Nat], [Result], []),
  "updateFoodItem": Func(
    [Text, Text, Nat, Bool, Text, Bool],
    [Result],
    []
  ),
  "updateOwnerProfile": Func(
    [Text, Text, Text, Bool],
    [Result],
    []
  ),
  "updatePlaySlot": Func(
    [Text, Text, Text, Nat, Text],
    [Result],
    []
  ),
  "updateRetailItem": Func(
    [Text, Text, Nat, Text, Bool, Nat],
    [Result],
    []
  ),
  "updateStayRoom": Func(
    [Text, Text, Vec(Text), Nat, Bool],
    [Result],
    []
  ),
  "updateSubscriptionStatus": Func(
    [Text, SubscriptionStatus, Timestamp, Text],
    [Result],
    []
  ),
  "updateUserProfile": Func(
    [Text, Text, Text, Float64, Float64],
    [Result],
    []
  ),
  "verifyOwner": Func([Text], [Result], []),
  "verifySubscriptionPayment": Func([Text, Text], [Result], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const CategoryEntry2 = IDL2.Record({
    "id": IDL2.Text,
    "name": IDL2.Text,
    "isActive": IDL2.Bool,
    "iconEmoji": IDL2.Text,
    "searchKeywords": IDL2.Vec(IDL2.Text),
    "tableType": Category2
  });
  const Result_102 = IDL2.Variant({ "ok": CategoryEntry2, "err": IDL2.Text });
  const FoodItem2 = IDL2.Record({
    "id": IDL2.Text,
    "ownerId": IDL2.Text,
  ...
  const Result_92 = IDL2.Variant({ "ok": FoodItem2, "err": IDL2.Text });
  const PlaySlot2 = IDL2.Record({
    "id": IDL2.Text,
    "startTime": IDL2.Text,
    "endTime": IDL2.Text,
    "ownerId": IDL2.Text,
    "surfaceType": IDL2.Text,
    "bookedByUserId": IDL2.Opt(IDL2.Text),
    "hourlyRate": IDL2.Nat,
    "description": IDL2.Text,
    "slotDate": IDL2.Text,
    "slotTime": IDL2.Text,
  ...
  const Result_82 = IDL2.Variant({ "ok": PlaySlot2, "err": IDL2.Text });
  const RetailItem2 = IDL2.Record({
    "id": IDL2.Text,
    "inStock": IDL2.Bool,
    "ownerId": IDL2.Text,
    "deliveryFeePerKm": IDL2.Nat,
    "itemName": IDL2.Text,
    "quantity": IDL2.Nat,
    "category": IDL2.Text,
    "priceInr": IDL2.Nat
  });
  const Result_72 = IDL2.Variant({ "ok": RetailItem2, "err": IDL2.Text });
  const StayRoom2 = IDL2.Record({
    "id": IDL2.Text,
    "ownerId": IDL2.Text,
    "pricePerNight": IDL2.Nat,
    "isAvailable": IDL2.Bool,
    "checkInDate": IDL2.Text,
    "amenities": IDL2.Vec(IDL2.Text),
    "checkOutDate": IDL2.Text,
    "roomName": IDL2.Text,
    "bookedDates": IDL2.Vec(IDL2.Text)
  });
  const Result_62 = IDL2.Variant({ "ok": StayRoom2, "err": IDL2.Text });
  const UserId2 = IDL2.Text;
  ...
  const OwnerRecord2 = IDL2.Record({
    "id": UserId2,
    "subscriptionExpiryDate": Timestamp2,
    "lastSubscriptionTxId": IDL2.Text,
    "name": IDL2.Text,
    "createdAt": Timestamp2,
    "role": UserRole2,
    "businessName": IDL2.Text,
    "isActive": IDL2.Bool,
    "lastSubscriptionPaymentDate": Timestamp2,
    "activityLog": IDL2.Vec(ActivityEntry2),
    ...
    "phone": IDL2.Text,
    "locationText": IDL2.Text,
    "gpsLat": IDL2.Float64,
    "gpsLng": IDL2.Float64
  });
  const Result_52 = IDL2.Variant({ "ok": OwnerRecord2, "err": IDL2.Text });
  ...
  const Result_42 = IDL2.Variant({ "ok": Booking2, "err": IDL2.Text });
  const SoundType2 = IDL2.Variant({
    "alarm": IDL2.Null,
    "ping": IDL2.Null,
    "silent": IDL2.Null
  });
  ...
  const Result_32 = IDL2.Variant({ "ok": Notification2, "err": IDL2.Text });
  const TicketStatus2 = IDL2.Variant({
    "resolved": IDL2.Null,
    "open": IDL2.Null
  });
  const TicketMessage2 = IDL2.Record({
    "text": IDL2.Text,
    "sender": IDL2.Text,
    "timestamp": Timestamp2
  });
  const Ticket2 = IDL2.Record({
    "id": IDL2.Text,
    "status": TicketStatus2,
    "messages": IDL2.Vec(TicketMessage2),
    "ownerId": IDL2.Opt(IDL2.Text),
    "createdAt": Timestamp2,
    "description": IDL2.Text,
  ...
  const Result_22 = IDL2.Variant({ "ok": Ticket2, "err": IDL2.Text });
  const AdminStats2 = IDL2.Record({
    "todayBookings": IDL2.Nat,
    "platformRevenue": IDL2.Nat,
    "totalUsers": IDL2.Nat,
    "totalOwners": IDL2.Nat
  });
  const UserRecord2 = IDL2.Record({
    "id": UserId2,
    "name": IDL2.Text,
    "createdAt": Timestamp2,
    "role": UserRole2,
  ...
  const OwnerRevenue2 = IDL2.Record({
    "ownerId": IDL2.Text,
    "businessName": IDL2.Text,
    "todayRevenue": IDL2.Nat,
    "totalRevenue": IDL2.Nat
  });
  const Result_12 = IDL2.Variant({ "ok": UserRecord2, "err": IDL2.Text });
  return IDL2.Service({
    "addBookedDate": IDL2.Func([IDL2.Text, IDL2.Text], [Result2], []),
    "addCategory": IDL2.Func(
      [IDL2.Text, IDL2.Text, Category2, IDL2.Vec(IDL2.Text)],
      [Result_102],
      []
    ),
    "addFoodItem": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Nat, IDL2.Bool, IDL2.Text],
      [Result_92],
      []
    ),
    "addPlaySlot": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Nat, IDL2.Text],
      [Result_82],
      []
    ),
    "addRetailItem": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Nat, IDL2.Text, IDL2.Nat],
      [Result_72],
      []
    ),
    "addStayRoom": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Vec(IDL2.Text), IDL2.Nat],
      [Result_62],
      []
    ),
    "addTicketMessage": IDL2.Func([IDL2.Text, IDL2.Text, IDL2.Text], [Result2], []),
    "banUser": IDL2.Func([IDL2.Text, IDL2.Bool], [Result2], []),
    "completeOwnerOnboarding": IDL2.Func(
      [IDL2.Text, IDL2.Text, Category2, IDL2.Text],
      [Result_52],
      []
    ),
    ...
    "createNotification": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, SoundType2],
      [Result_32],
      []
    ),
    "createStayBooking": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text],
      [Result2],
      []
    ),
    "createTicket": IDL2.Func(
      [IDL2.Text, IDL2.Opt(IDL2.Text), IDL2.Text, IDL2.Text, IDL2.Opt(IDL2.Text)],
      [Result_22],
      []
    ),
    "deleteCategory": IDL2.Func([IDL2.Text], [Result2], []),
    "deleteFoodItem": IDL2.Func([IDL2.Text], [Result2], []),
    "deleteOwner": IDL2.Func([IDL2.Text], [Result2], []),
    "deleteUser": IDL2.Func([IDL2.Text], [Result2], []),
    "getActiveCategories": IDL2.Func([], [IDL2.Vec(CategoryEntry2)], ["query"]),
    "getActiveOwners": IDL2.Func([], [IDL2.Vec(OwnerRecord2)], ["query"]),
    "getAdminStats": IDL2.Func([], [AdminStats2], ["query"]),
    "getAllBookings": IDL2.Func([], [IDL2.Vec(Booking2)], ["query"]),
    "getAllCategories": IDL2.Func([], [IDL2.Vec(CategoryEntry2)], ["query"]),
    "getAllFoodItems": IDL2.Func([], [IDL2.Vec(FoodItem2)], ["query"]),
    "getAllNotifications": IDL2.Func([], [IDL2.Vec(Notification2)], ["query"]),
    "getAllOwners": IDL2.Func([], [IDL2.Vec(OwnerRecord2)], ["query"]),
    "getAllOwnersAdmin": IDL2.Func([], [IDL2.Vec(OwnerRecord2)], ["query"]),
    "getAllPlaySlots": IDL2.Func([], [IDL2.Vec(PlaySlot2)], ["query"]),
    "getAllRetailItems": IDL2.Func([], [IDL2.Vec(RetailItem2)], ["query"]),
    "getAllStayRooms": IDL2.Func([], [IDL2.Vec(StayRoom2)], ["query"]),
    "getAllTickets": IDL2.Func([], [IDL2.Vec(Ticket2)], ["query"]),
    "getAllUsers": IDL2.Func([], [IDL2.Vec(UserRecord2)], ["query"]),
    "getBookingsByOwner": IDL2.Func([IDL2.Text], [IDL2.Vec(Booking2)], ["query"]),
    "getBookingsByUser": IDL2.Func([IDL2.Text], [IDL2.Vec(Booking2)], ["query"]),
    "getDeliveryFee": IDL2.Func(
      [IDL2.Text, IDL2.Float64, IDL2.Float64],
      [IDL2.Nat],
      ["query"]
    ),
    "getFoodItemsByOwner": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(FoodItem2)],
      ["query"]
    ),
    "getNotificationsByTarget": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(Notification2)],
      ["query"]
    ),
    "getOwnerById": IDL2.Func([IDL2.Text], [IDL2.Opt(OwnerRecord2)], ["query"]),
    "getOwnersByCategory": IDL2.Func(
      [Category2],
      [IDL2.Vec(OwnerRecord2)],
      ["query"]
    ),
    "getPlaySlotsByOwner": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(PlaySlot2)],
      ["query"]
    ),
    "getRetailItemsByOwner": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(RetailItem2)],
      ["query"]
    ),
    "getRevenueByOwner": IDL2.Func([], [IDL2.Vec(OwnerRevenue2)], ["query"]),
    "getSlotsByDate": IDL2.Func(
      [IDL2.Text, IDL2.Text],
      [IDL2.Vec(PlaySlot2)],
      ["query"]
    ),
    "getStayAvailability": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text],
      [IDL2.Bool],
      ["query"]
    ),
    "getStayRoomsByOwner": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(StayRoom2)],
      ["query"]
    ),
    "getTicketsByOwner": IDL2.Func([IDL2.Text], [IDL2.Vec(Ticket2)], ["query"]),
    "getTicketsByUser": IDL2.Func([IDL2.Text], [IDL2.Vec(Ticket2)], ["query"]),
    "getUserById": IDL2.Func([IDL2.Text], [IDL2.Opt(UserRecord2)], ["query"]),
    "logActivity": IDL2.Func([IDL2.Text, IDL2.Text], [], []),
    "markNotificationRead": IDL2.Func([IDL2.Text], [Result2], []),
    "resolveTicket": IDL2.Func([IDL2.Text], [Result2], []),
    "signinUser": IDL2.Func([IDL2.Text, IDL2.Text], [Result_12], []),
    "signupUser": IDL2.Func(
      [
        IDL2.Text,
        IDL2.Text,
        IDL2.Text,
    ...
    "toggleSlotBooking": IDL2.Func(
      [IDL2.Text, IDL2.Bool, IDL2.Opt(IDL2.Text)],
      [Result2],
      []
    ),
    "updateBookingStatus": IDL2.Func([IDL2.Text, BookingStatus2], [Result2], []),
    "updateCategory": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Bool, IDL2.Vec(IDL2.Text)],
      [Result2],
      []
    ),
    "updateDeliveryFeePerKm": IDL2.Func([IDL2.Text, IDL2.Nat], [Result2], []),
    "updateFoodItem": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Nat, IDL2.Bool, IDL2.Text, IDL2.Bool],
      [Result2],
      []
    ),
    "updateOwnerProfile": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Bool],
      [Result2],
      []
    ),
    "updatePlaySlot": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Nat, IDL2.Text],
      [Result2],
      []
    ),
    "updateRetailItem": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Nat, IDL2.Text, IDL2.Bool, IDL2.Nat],
      [Result2],
      []
    ),
    "updateStayRoom": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Vec(IDL2.Text), IDL2.Nat, IDL2.Bool],
      [Result2],
      []
    ),
    "updateSubscriptionStatus": IDL2.Func(
      [IDL2.Text, SubscriptionStatus2, Timestamp2, IDL2.Text],
      [Result2],
      []
    ),
    "updateUserProfile": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Float64, IDL2.Float64],
      [Result2],
      []
    ),
    "verifyOwner": IDL2.Func([IDL2.Text], [Result2], []),
    "verifySubscriptionPayment": IDL2.Func([IDL2.Text, IDL2.Text], [Result2], [])
  });
};
...
class Backend {
  ...
  async addCategory(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
  ...
  async addFoodItem(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
  ...
  async addPlaySlot(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    if (this.processError) {
      try {
  ...
  async addRetailItem(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
  ...
  async addStayRoom(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
  ...
  async addTicketMessage(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async completeOwnerOnboarding(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
  ...
  async createBooking(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
    if (this.processError) {
      try {
  ...
  async createNotification(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
  ...
  async createStayBooking(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async createTicket(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
  ...
  async getDeliveryFee(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async getFoodItemsByOwner(arg0) {
    if (this.processError) {
      try {
  ...
  async getNotificationsByTarget(arg0) {
    if (this.processError) {
      try {
  ...
  async getOwnersByCategory(arg0) {
    if (this.processError) {
      try {
  ...
  async getPlaySlotsByOwner(arg0) {
    if (this.processError) {
      try {
  ...
  async getRetailItemsByOwner(arg0) {
    if (this.processError) {
      try {
  ...
  async getSlotsByDate(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async getStayAvailability(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async getStayRoomsByOwner(arg0) {
    if (this.processError) {
      try {
  ...
  async signupUser(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    if (this.processError) {
      try {
  ...
  async toggleSlotBooking(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async updateCategory(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
  ...
  async updateDeliveryFeePerKm(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async updateFoodItem(arg0, arg1, arg2, arg3, arg4, arg5) {
    if (this.processError) {
      try {
  ...
  async updateOwnerProfile(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
  ...
  async updatePlaySlot(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
  ...
  async updateRetailItem(arg0, arg1, arg2, arg3, arg4, arg5) {
    if (this.processError) {
      try {
  ...
  async updateStayRoom(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
  ...
  async updateSubscriptionStatus(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
  ...
  async updateUserProfile(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
  ...
  async verifySubscriptionPayment(arg0, arg1) {
    if (this.processError) {
      try {
...
function from_candid_BookingStatus_n34(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n35(_uploadFile, _downloadFile, value);
}
function from_candid_Booking_n32(_uploadFile, _downloadFile, value) {
  return from_candid_record_n33(_uploadFile, _downloadFile, value);
}
function from_candid_CategoryEntry_n7(_uploadFile, _downloadFile, value) {
  return from_candid_record_n8(_uploadFile, _downloadFile, value);
}
function from_candid_Category_n9(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n10(_uploadFile, _downloadFile, value);
}
function from_candid_Notification_n40(_uploadFile, _downloadFile, value) {
  return from_candid_record_n41(_uploadFile, _downloadFile, value);
}
function from_candid_OwnerRecord_n24(_uploadFile, _downloadFile, value) {
  return from_candid_record_n25(_uploadFile, _downloadFile, value);
}
function from_candid_PlaySlot_n15(_uploadFile, _downloadFile, value) {
  return from_candid_record_n16(_uploadFile, _downloadFile, value);
}
function from_candid_Result_10_n5(_uploadFile, _downloadFile, value) {
...
function from_candid_Result_2_n45(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n46(_uploadFile, _downloadFile, value);
}
function from_candid_Result_3_n38(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n39(_uploadFile, _downloadFile, value);
}
function from_candid_Result_4_n30(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n31(_uploadFile, _downloadFile, value);
}
function from_candid_Result_5_n22(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n23(_uploadFile, _downloadFile, value);
}
function from_candid_Result_6_n20(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n21(_uploadFile, _downloadFile, value);
}
function from_candid_Result_7_n18(_uploadFile, _downloadFile, value) {
...
function from_candid_SoundType_n42(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n43(_uploadFile, _downloadFile, value);
}
function from_candid_SubscriptionStatus_n28(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n29(_uploadFile, _downloadFile, value);
}
function from_candid_TicketStatus_n49(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n50(_uploadFile, _downloadFile, value);
}
function from_candid_Ticket_n47(_uploadFile, _downloadFile, value) {
  return from_candid_record_n48(_uploadFile, _downloadFile, value);
}
function from_candid_UserRecord_n58(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n10(_uploadFile, _downloadFile, value) {
  return "retail" in value ? "retail" : "food" in value ? "food" : "play" in value ? "play" : "stay" in value ? "stay" : value;
}
...
function from_candid_variant_n27(_uploadFile, _downloadFile, value) {
  return "admin" in value ? "admin" : "owner" in value ? "owner" : "user" in value ? "user" : value;
}
function from_candid_variant_n29(_uploadFile, _downloadFile, value) {
  return "active" in value ? "active" : "expired" in value ? "expired" : "inactive" in value ? "inactive" : value;
}
...
function from_candid_variant_n35(_uploadFile, _downloadFile, value) {
  return "pending" in value ? "pending" : "completed" in value ? "completed" : "accepted" in value ? "accepted" : "declined" in value ? "declined" : value;
}
...
function from_candid_variant_n43(_uploadFile, _downloadFile, value) {
  return "alarm" in value ? "alarm" : "ping" in value ? "ping" : "silent" in value ? "silent" : value;
}
...
function from_candid_variant_n50(_uploadFile, _downloadFile, value) {
  return "resolved" in value ? "resolved" : "open" in value ? "open" : value;
}
...
function from_candid_vec_n51(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_CategoryEntry_n7(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n52(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_OwnerRecord_n24(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n53(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Booking_n32(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n54(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Notification_n40(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n55(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_PlaySlot_n15(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n56(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Ticket_n47(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n57(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_UserRecord_n58(_uploadFile, _downloadFile, x2));
}
...
function to_candid_SoundType_n36(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n37(_uploadFile, _downloadFile, value);
}
function to_candid_SubscriptionStatus_n68(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n69(_uploadFile, _downloadFile, value);
}
function to_candid_UserRole_n64(_uploadFile, _downloadFile, value) {
...
function useCompleteOwnerOnboarding() {
  const { actor } = useBackend();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: ({
...
function useVerifySubscriptionPayment() {
  const { actor } = useBackend();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: ({ ownerId, txId }) => {
      if (!actor) throw new Error("Backend not ready");
...
function useFoodItemsByOwner(ownerId) {
  const { actor, isFetching } = useBackend();
  return useQuery({
...
function useStayRoomsByOwner(ownerId) {
  const { actor, isFetching } = useBackend();
  return useQuery({
...
function usePlaySlotsByOwner(ownerId) {
  const { actor, isFetching } = useBackend();
  return useQuery({
...
function useSlotsByDate(ownerId, date) {
  const { actor, isFetching } = useBackend();
  return useQuery({
...
function useRetailItemsByOwner(ownerId) {
  const { actor, isFetching } = useBackend();
  return useQuery({
...
function useUpdateDeliveryFeePerKm() {
  const { actor } = useBackend();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: ({ ownerId, rate }) => {
      if (!actor) throw new Error("Backend not ready");
...
function useBookingsByUser(userId) {
  const { actor, isFetching } = useBackend();
  return useQuery({
...
function useBookingsByOwner(ownerId) {
  const { actor, isFetching } = useBackend();
  return useQuery({
...
function useGetDeliveryFee(ownerId, lat, lng, enabled) {
  const { actor, isFetching } = useBackend();
  return useQuery({
...
function useTicketsByUser(userId) {
  const { actor, isFetching } = useBackend();
  return useQuery({
...
function useTicketsByOwner(ownerId) {
  const { actor, isFetching } = useBackend();
  return useQuery({
...
function useUpdateUserProfile() {
  ...
  return useMutation({
    ...
    onSuccess: (_2, vars) => qc.invalidateQueries({ queryKey: ["user", vars.id] })
  });
}
function useUpdateOwnerProfile() {
  const { actor } = useBackend();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: (args) => {
    ...
    onSuccess: (_2, vars) => qc.invalidateQueries({ queryKey: ["owner", vars.id] })
  });
}
export {
  useAddRetailItem as A,
  useUpdateRetailItem as B,
  useUpdateDeliveryFeePerKm as C,
  useCompleteOwnerOnboarding as D,
  useUpdateBookingStatus as E,
  useTicketsByOwner as F,
  useVerifySubscriptionPayment as G,
  useSignin as H,
  useSignup as I,
  useAdminStats as J,
  useAllCategories as K,
  useRevenueByOwner as L,
  useAllUsers as M,
  useAllOwners as N,
  useBanUser as O,
  useVerifyOwner as P,
  ...
  useAddCategory as U,
  useAllTickets as V,
  useResolveTicket as W,
  useAllNotifications as X,
  useCreateNotification as Y,
  useUpdateUserProfile as a,
  useBookingsByUser as b,
  useCreateBooking as c,
  useGetDeliveryFee as d,
  useAllFoodItems as e,
  useAllStayRooms as f,
  useAllPlaySlots as g,
  useAllRetailItems as h,
  useGetOwnerById as i,
  useSlotsByDate as j,
  useTicketsByUser as k,
  useCreateTicket as l,
  useAddTicketMessage as m,
  useUpdateOwnerProfile as n,
  useBookingsByOwner as o,
  useFoodItemsByOwner as p,
  useUpdateFoodItem as q,
  useAddFoodItem as r,
  usePlaySlotsByOwner as s,
  useAddPlaySlot as t,
  useGetUserById as u,
  useToggleSlotBooking as v,
  useStayRoomsByOwner as w,
  useAddStayRoom as x,
  useUpdateStayRoom as y,
  useRetailItemsByOwner as z
};
