...
import { S as Subscribable, p as pendingThenable, b as resolveEnabled, d as shallowEqualObjects, e as resolveStaleTime, n as noop, f as environmentManager, i as isValidTimeout, t as timeUntilStale, h as timeoutManager, k as focusManager, l as fetchState, m as replaceData, q as notifyManager, w as hashKey, x as getDefaultState, r as reactExports, y as shouldThrowError, z as useQueryClient } from "./index-CnBlQnJS.js";
...
Service({
  ...
  "createBooking": Func(
    [Text, Text, Category, Text, Nat, Text],
    [Result_4],
    []
  ),
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  return IDL2.Service({
    ...
    "createBooking": IDL2.Func(
      [IDL2.Text, IDL2.Text, Category2, IDL2.Text, IDL2.Nat, IDL2.Text],
      [Result_42],
      []
    ),
...
class Backend {
  ...
  async addPlaySlot(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
        const result = await this.actor.addPlaySlot(arg0, arg1, arg2, arg3, arg4);
  ...
  async createBooking(arg0, arg1, arg2, arg3, arg4, arg5) {
    if (this.processError) {
      try {
        const result = await this.actor.createBooking(arg0, arg1, to_candid_Category_n3(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5);
  ...
  async createNotification(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
        const result = await this.actor.createNotification(arg0, arg1, arg2, to_candid_SoundType_n34(this._uploadFile, this._downloadFile, arg3));
  ...
  async createTicket(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
        const result = await this.actor.createTicket(arg0, to_candid_opt_n42(this._uploadFile, this._downloadFile, arg1), arg2, arg3, to_candid_opt_n42(this._uploadFile, this._downloadFile, arg4));
  ...
  async signinUser(arg0, arg1) {
    if (this.processError) {
      try {
        ...
        return from_candid_Result_1_n60(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async signupUser(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    if (this.processError) {
      try {
        const result = await this.actor.signupUser(arg0, arg1, arg2, to_candid_UserRole_n62(this._uploadFile, this._downloadFile, arg3), arg4, arg5, arg6);
        return from_candid_Result_1_n60(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async toggleSlotBooking(arg0, arg1, arg2) {
    if (this.processError) {
      try {
        const result = await this.actor.toggleSlotBooking(arg0, arg1, to_candid_opt_n42(this._uploadFile, this._downloadFile, arg2));
        return from_candid_Result_n1(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateBookingStatus(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateBookingStatus(arg0, to_candid_BookingStatus_n64(this._uploadFile, this._downloadFile, arg1));
        return from_candid_Result_n1(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
function from_candid_BookingStatus_n32(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n33(_uploadFile, _downloadFile, value);
}
function from_candid_Booking_n30(_uploadFile, _downloadFile, value) {
...
function from_candid_Notification_n38(_uploadFile, _downloadFile, value) {
...
function from_candid_Result_1_n60(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n61(_uploadFile, _downloadFile, value);
}
function from_candid_Result_2_n43(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n44(_uploadFile, _downloadFile, value);
}
function from_candid_Result_3_n36(_uploadFile, _downloadFile, value) {
...
function from_candid_SoundType_n40(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n41(_uploadFile, _downloadFile, value);
}
function from_candid_TicketStatus_n47(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n48(_uploadFile, _downloadFile, value);
}
function from_candid_Ticket_n45(_uploadFile, _downloadFile, value) {
  return from_candid_record_n46(_uploadFile, _downloadFile, value);
}
function from_candid_UserRecord_n56(_uploadFile, _downloadFile, value) {
...
function from_candid_opt_n59(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_UserRecord_n56(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n39(_uploadFile, _downloadFile, value) {
  return {
    ...
    body: value.body,
    createdAt: value.createdAt,
    soundType: from_candid_SoundType_n40(_uploadFile, _downloadFile, value.soundType),
    isRead: value.isRead,
    target: value.target
  };
}
function from_candid_record_n46(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    status: from_candid_TicketStatus_n47(_uploadFile, _downloadFile, value.status),
...
function from_candid_variant_n29(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
    ok: from_candid_Booking_n30(_uploadFile, _downloadFile, value.ok)
  } : "err" in value ? {
    __kind__: "err",
    err: value.err
  } : value;
...
function from_candid_variant_n37(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
    ok: from_candid_Notification_n38(_uploadFile, _downloadFile, value.ok)
  } : "err" in value ? {
    __kind__: "err",
    err: value.err
  } : value;
...
function from_candid_variant_n44(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
    ok: from_candid_Ticket_n45(_uploadFile, _downloadFile, value.ok)
  } : "err" in value ? {
    __kind__: "err",
    err: value.err
  } : value;
...
function from_candid_variant_n61(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
    ok: from_candid_UserRecord_n56(_uploadFile, _downloadFile, value.ok)
  } : "err" in value ? {
    __kind__: "err",
    err: value.err
  } : value;
...
function from_candid_vec_n50(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Booking_n30(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n51(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Notification_n38(_uploadFile, _downloadFile, x2));
}
...
function from_candid_vec_n54(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Ticket_n45(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n55(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_UserRecord_n56(_uploadFile, _downloadFile, x2));
}
function to_candid_BookingStatus_n64(_uploadFile, _downloadFile, value) {
...
function to_candid_SoundType_n34(_uploadFile, _downloadFile, value) {
...
export {
  useUpdateRetailItem as A,
  useCompleteOwnerOnboarding as B,
  useUpdateBookingStatus as C,
  useTicketsByOwner as D,
  useSignin as E,
  useSignup as F,
  useAdminStats as G,
  useAllCategories as H,
  useRevenueByOwner as I,
  useAllUsers as J,
  useAllOwners as K,
  useBanUser as L,
  useVerifyOwner as M,
  useUpdateCategory as N,
  useDeleteCategory as O,
  useAddCategory as P,
  useAllTickets as Q,
  useResolveTicket as R,
  useAllNotifications as S,
  useCreateNotification as T,
  useUpdateUserProfile as a,
  useBookingsByUser as b,
  useCreateBooking as c,
  useAllFoodItems as d,
  useAllStayRooms as e,
  useAllPlaySlots as f,
  useAllRetailItems as g,
  useGetOwnerById as h,
  useTicketsByUser as i,
  useCreateTicket as j,
  useAddTicketMessage as k,
  useUpdateOwnerProfile as l,
  useFoodItemsByOwner as m,
  useBookingsByOwner as n,
  useUpdateFoodItem as o,
  useAddFoodItem as p,
  usePlaySlotsByOwner as q,
  useAddPlaySlot as r,
  useUpdatePlaySlot as s,
  useToggleSlotBooking as t,
  useGetUserById as u,
  useStayRoomsByOwner as v,
  useAddStayRoom as w,
  useUpdateStayRoom as x,
  useRetailItemsByOwner as y,
  useAddRetailItem as z
};
